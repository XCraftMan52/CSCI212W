      ...
      JSpinner spinPages = new JSpinner(spinnerModel);
	   ...
	   priorButton.addActionListener(new ActionListener()
	   {
			public void actionPerformed(ActionEvent e)
			{
		       ...
		       txtTitle.setText(tBooks[bookCtr].GetTitle());
			   txtAuthFirst.setText(tBooks[bookCtr].GetAuthFirst());
			   txtAuthLast.setText(tBooks[bookCtr].GetAuthLast());
			   txtEmail.setText(tBooks[bookCtr].GetEmail());
			   txtDatePublished.setText(tBooks[bookCtr].GetDatePublished().toString());
			   Double tPrice = tBooks[bookCtr].GetPrice();
			   txtPrice.setText(tPrice.toString());
			}
	   });
	   ...
	   nextButton.addActionListener(new ActionListener()
	   {
			public void actionPerformed(ActionEvent e)
			{
				...
				if (bookCtr >= tBooks.length)
				{
					bookCtr = tBooks.length-1;
				}
